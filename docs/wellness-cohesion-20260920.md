...
- [ ] 3–4: coherent cards, template selection and overview order.
- [ ] 5–6: stable shared navigation and typography roles.
- [ ] 7–8: selective action lighting and atmosphere below the hero.
