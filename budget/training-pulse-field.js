(function () {
  ...
  function renderActivity() {
    ...
    var svg='<svg viewBox="0 0 '+width+' '+height+'" preserveAspectRatio="none" aria-hidden="true"><defs><linearGradient id="bar-light" x1="0" y1="1" x2="0" y2="0"><stop stop-color="#ff657a"/><stop offset="1" stop-color="#ffd1ba"/></linearGradient><filter id="bar-glow-near" x="-100%" y="-35%" width="300%" height="170%" color-interpolation-filters="sRGB"><feGaussianBlur stdDeviation="2.2"/></filter><filter id="bar-glow-wide" x="-160%" y="-45%" width="420%" height="190%" color-interpolation-filters="sRGB"><feGaussianBlur stdDeviation="5.8"/></filter></defs>';
