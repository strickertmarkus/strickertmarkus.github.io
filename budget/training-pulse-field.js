(function () {
  ...
  function renderActivity() {
    ...
    var svg='<svg viewBox="0 0 '+width+' '+height+'" preserveAspectRatio="none" aria-hidden="true"><defs><linearGradient id="bar-light" x1="0" y1="1" x2="0" y2="0"><stop stop-color="#ff657a" stop-opacity=".15"/><stop offset="1" stop-color="#ff9a91"/></linearGradient></defs>';
