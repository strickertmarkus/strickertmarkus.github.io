(function(){
  ...
  $('create-routine').onclick=()=>openBuilder(kind==='stretch'?{id:id(),kind,name:'',steps:[{...M.poses[0],seconds:60},{...M.poses[9],seconds:60}]}:{id:id(),kind,name:'',seconds:600,guidance:'breath'},true);
