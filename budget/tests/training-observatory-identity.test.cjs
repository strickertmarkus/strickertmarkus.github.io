...
test('boot keeps the current shared wellness ownership fresh and CP10 routes dashboard JS to one owner', () => {
  assert.match(html, /auth-config\.js\?v=20260926-embedded-builder-fast-4/);
  assert.match(html, /auth-gate\.js\?v=20260926-embedded-builder-fast-3/);
  ...
  assert.match(authConfig, /exerciseFastVersion = '20260926-embedded-builder-layout-2'/);
  assert.match(authGate, /exerciseAssetsVersion = '20260926-embedded-builder-layout-2'/);
});
