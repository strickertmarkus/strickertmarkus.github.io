...
test('production pages cache-bust the shared wellness owners',()=>{
  ...
  assert.match(exercise,/auth-gate\.js\?v=20260922-observatory-records-3/);
  ...
  assert.match(zen,/zen\.css\?v=20260924-zen-fullbleed-nav-4/);
  assert.match(zen,/zen\.js\?v=20260924-canonical-train-1/);
});
