(function () {
  ...
  function installStyles() {
    ...
    style.textContent =
      ...
      'html.finance-ui-clean-v1 body .header #month-dropdown{appearance:none!important;height:40px!important;width:154px!important;min-width:154px!important;margin:0!important;padding:0 8px!important;border:0!important;border-radius:0!important;background:transparent!important;background-image:none!important;color:#FB923C!important;font:680 15px/1 Inter,sans-serif!important;letter-spacing:-.10px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:clip!important;text-align:center!important;box-shadow:none!important;text-shadow:0 2px 10px rgba(251,146,60,.14)!important;transform:none!important;cursor:pointer!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;transition:color .15s,opacity .15s!important}' +
      'html.finance-ui-clean-v1 body .header #month-dropdown:hover{color:#FDBA74!important}html.finance-ui-clean-v1 body .header #month-dropdown:active{color:#F97316!important;opacity:.88!important}' +
      ...
      '.container.finance-departing-clean-v1{transform-origin:center top;pointer-events:none;animation:financeDepartCleanV1 .14s cubic-bezier(.32,.72,0,1) both;will-change:transform,filter}' +
      ...
      '@media(prefers-reduced-motion:reduce){.container.finance-arrival-clean-v1,.container.finance-departing-clean-v1{animation:none!important;filter:none!important;transform:none!important}}';
