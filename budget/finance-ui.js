(function () {
  ...
  function installStyles() {
    ...
    style.textContent =
      ...
      'html[data-finance-view="budget"].finance-ui-clean-v1 body #pieChart{filter:drop-shadow(0 0 9px rgba(var(--finance-accent-rgb),.16))!important;transition:filter .18s ease!important}' +
