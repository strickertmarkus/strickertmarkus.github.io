(function () {
  ...
  function installFinancePreload() {
    ...
    if (!document.getElementById('finance-ui-preload-v2-style')) {
      ...
      critical.textContent =
        'html.finance-ui-preload-v2,html.finance-ui-preload-v2 body{background:radial-gradient(760px 300px at 50% -90px,rgba(var(--finance-accent-rgb),.10),transparent 66%),#0F1219!important}' +
  ...
  function installStyles() {
    ...
    style.textContent =
      'html.finance-ui-clean-v1 body{background:radial-gradient(900px 380px at 50% -110px,rgba(var(--finance-accent-rgb),.085),transparent 67%),#0F1219!important}' +
      ...
      'html.finance-ui-clean-v1 body .header #month-dropdown{appearance:none!important;height:40px!important;width:154px!important;min-width:154px!important;margin:0!important;padding:0 8px!important;border:0!important;border-radius:0!important;background:transparent!important;background-image:none!important;color:var(--finance-accent)!important;font:680 15px/1 Inter,sans-serif!important;letter-spacing:-.10px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:clip!important;text-align:center!important;box-shadow:none!important;text-shadow:0 2px 10px rgba(var(--finance-accent-rgb),.14)!important;transform:none!important;cursor:pointer!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;transition:color .15s,opacity .15s!important}' +
      'html.finance-ui-clean-v1 body .header #month-dropdown:hover{color:var(--finance-accent-hover)!important}html.finance-ui-clean-v1 body .header #month-dropdown:active{color:var(--finance-accent-active)!important;opacity:.88!important}' +
