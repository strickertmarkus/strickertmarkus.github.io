(function () {
  ...
  function renderRow(rec) {
    ...
    if(document.documentElement.dataset.trainingOverview!=='observatory'){
    ...
    return '<details class="record-row-v52"><summary class="record-summary">'
      +'<div class="record-name-v52">'+esc(rec.label)+'</div>'
      +'<div class="record-max-v52">'+esc(fmtWeight(rec.max))+'</div>'
      +'</summary><div class="record-progress-v52">'+sparkline(rec.history,rec.delta>0)+'<div class="record-progress-copy-v52"><span>'+esc(firstToMax)+'</span>'+gain+'</div></div>'
      +'</details>';
  }
  ...
  function install(){
    addStyles(); renderStrengthRecords(true);
