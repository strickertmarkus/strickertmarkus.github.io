(function () {
  ...
  if (window.__exerciseHeartRateRangeInstalled) return;
  window.__exerciseHeartRateRangeInstalled = true;
  ...
  function renderRangeChart(force) {
    ...
    if (canvas.__pulseRangeChart && canvas.__pulseRangeChart !== existing) { try { canvas.__pulseRangeChart.destroy(); } catch (e) {} }
    if (rangeChart && rangeChart !== existing && rangeChart !== canvas.__pulseRangeChart) {
    ...
    canvas.__pulseRangeChart = rangeChart;
