(function () {
  ...
  // exercise-heart-rate-range.js is the sole HR chart owner.
  ...
  function install() {
    ...
    function ready() {
      attempts++;
      if (typeof window.getWorkouts !== 'function' || typeof window.Chart !== 'function' || !document.getElementById('last-d') || !document.getElementById('chart-hr-combined')) {
